  ...
  return (
    <div className="project-create-overlay" onMouseDown={handleOverlayMouseDown}>
      ...
      <style>{`
        ...
        .project-create-dialog { background: #fff; border: 1px solid #dedfd9; border-radius: 8px; box-shadow: 0 20px 58px rgb(18 22 19 / 25%); color: #282a27; max-width: 510px; width: 100%; }
        .project-create-dialog__header { align-items: flex-start; border-bottom: 1px solid #e8e8e3; display: flex; gap: 16px; justify-content: space-between; padding: 24px 24px 20px; }
        .project-create-dialog__eyebrow { color: #6b6e68; font-size: 11px; font-weight: 750; letter-spacing: .08em; margin: 0 0 6px; text-transform: uppercase; }
        .project-create-dialog h2 { font-size: 23px; letter-spacing: 0; line-height: 1.2; margin: 0; }
        .project-create-dialog__header p:last-child { color: #70736d; font-size: 14px; line-height: 1.45; margin: 7px 0 0; }
        .project-create-dialog__close { align-items: center; background: transparent; border: 0; border-radius: 6px; color: #777a74; cursor: pointer; display: inline-flex; font-size: 21px; height: 32px; justify-content: center; line-height: 1; padding: 0; width: 32px; }
        .project-create-dialog__close:hover { background: #f0f0ec; color: #292b28; }
        .project-create-dialog__form { display: grid; gap: 18px; padding: 22px 24px 24px; }
        .project-create-dialog__field { color: #363834; display: grid; font-size: 13px; font-weight: 700; gap: 7px; }
        .project-create-dialog__field em { color: #898c85; font-size: 12px; font-style: normal; font-weight: 500; }
        .project-create-dialog__field input, .project-create-dialog__field textarea { background: #fff; border: 1px solid #d5d6d0; border-radius: 6px; box-sizing: border-box; color: #282a27; font: inherit; font-weight: 500; outline: none; padding: 10px 11px; resize: vertical; width: 100%; }
        .project-create-dialog__field input { min-height: 42px; }
        .project-create-dialog__field textarea { line-height: 1.45; min-height: 82px; }
        .project-create-dialog__field input:focus, .project-create-dialog__field textarea:focus { border-color: #315bd7; box-shadow: 0 0 0 3px rgb(49 91 215 / 16%); }
        .project-create-dialog__field small { color: #787b75; font-size: 12px; font-weight: 500; line-height: 1.35; }
        .project-create-dialog__error { color: #b42318 !important; }
        .project-create-dialog__colors { border: 0; margin: 0; padding: 0; }
        .project-create-dialog__colors legend { color: #363834; font-size: 13px; font-weight: 700; margin-bottom: 9px; padding: 0; }
        ...
        .project-create-dialog__color > span:first-of-type { border: 3px solid #fff; border-radius: 50%; box-shadow: 0 0 0 1px #d4d5d0; height: 25px; transition: box-shadow .15s ease, transform .15s ease; width: 25px; }
        .project-create-dialog__color input:checked + span { box-shadow: 0 0 0 2px #282a27; transform: scale(1.08); }
        .project-create-dialog__color input:focus-visible + span { box-shadow: 0 0 0 2px #315bd7; }
        .project-create-dialog__actions { align-items: center; border-top: 1px solid #e8e8e3; display: flex; gap: 10px; justify-content: flex-end; margin: 4px -24px -24px; padding: 16px 24px; }
        ...
        .project-create-dialog__cancel { background: #fff; border: 1px solid #d5d6d0; color: #444640; }
        .project-create-dialog__cancel:hover { background: #f5f5f1; }
        .project-create-dialog__submit { background: #272926; border: 1px solid #272926; color: #fff; }
        .project-create-dialog__submit:hover { background: #494b47; border-color: #494b47; }
        .project-create-dialog__close:focus-visible, .project-create-dialog__actions button:focus-visible { outline: 2px solid #315bd7; outline-offset: 2px; }
