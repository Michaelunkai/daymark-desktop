...
public final class ReminderAlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        builder.setSmallIcon(android.R.drawable.ic_popup_reminder)
                ...
                .setStyle(new Notification.BigTextStyle().bigText(content + (ReminderScheduler.details(intent) == null || ReminderScheduler.details(intent).isEmpty() ? "" : "\n" + ReminderScheduler.details(intent))))
                .setAutoCancel(true)
